...
import { API_URL_AUTH, REDIRECT_URI, RESPONSE_TYPE, SCOPE, ACCESS_KEY, API_URL_TOKEN, SECRET_KEY } from "./const.js";

import { getrUserData } from './getrUserData.js'
...
export const autorization = async (btn) => {
    ...
    if (await checkLogin()) {
        const dataUser = await getrUserData()
